...
class TabHorizontal(tk.Frame):
    ...
    def init_ui(self):
        ...
        tk.Label(self.frame_settings, text="Время полета(с)").grid(row=2, column=0, sticky=tk.W)
        tk.Label(self.frame_settings, text="Точка падения X(м)").grid(row=3, column=0, sticky=tk.W)
        tk.Label(self.frame_settings, text="Ускорение g(м/с^2)").grid(row=4, column=0, sticky=tk.W)
        ...
        tk.Label(self.frame_result, text="Время полета(с)").grid(row=3, column=0, sticky=tk.W)
        tk.Label(self.frame_result, text="Координата падения X(м)").grid(row=4, column=0, sticky=tk.W)
        tk.Label(self.frame_result, text="Конечная скорость по X(м/с)").grid(row=5, column=0, sticky=tk.W)
        tk.Label(self.frame_result, text="Конечная скорость по Y(м/с)").grid(row=6, column=0, sticky=tk.W)
        tk.Label(self.frame_result, text="Конечная скорость(м/с)").grid(row=7, column=0, sticky=tk.W)
        tk.Label(self.frame_result, text="Угол beta(градусы)").grid(row=8, column=0, sticky=tk.W)
        ...
        tk.Button(self.frame_result, text="Сохранить результаты", command=self.save_file).grid(row=9, column=0,
                                                                                               columnspan=2)
        tk.Button(self.frame_result, text="Открыть документ-справку", command=self.open_help).grid(row=10, column=0,
                                                                                                   columnspan=2)
    ...
    def open_help(self):
        webbrowser.open("Движение тела, брошенного горизонтально.pdf")
